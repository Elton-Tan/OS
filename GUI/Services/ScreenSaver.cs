...
namespace TangerineOS.GUI
{
    public class ScreenSaver
    {
        ...
        public static void Update()
        {
            ...
            Font.DrawString(TangerineOS.Date.CurrentTime(true),System.Drawing.Color.White, (int)GUI.screenX - 200, (int)GUI.screenY - 36);
            Font.DrawString(TangerineOS.Date.CurrentDate(true, false), System.Drawing.Color.White, (int)GUI.screenX - 200, (int)GUI.screenY - 20);
        }
    }
