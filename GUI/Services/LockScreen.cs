...
namespace TangerineOS.GUI
{
    public class LockScreen
    {
        ...
        public static void Update()
        {
            ...
            Font.DrawString(TangerineOS.Date.CurrentTime(false),Color.White, (int)GUI.screenX / 2 - 30, (int)GUI.screenY / 3 - 80);
            Font.DrawString(TangerineOS.Date.CurrentDate(true, false),Color.White, (int)GUI.screenX / 2 - 80, (int)GUI.screenY / 3 - 60);
            if (Menu)
            {
